...
cl = LINETCR.LINE()
cl.login(token="En9D54Az5c580fhdTGDc.YLgVP2FFH7O3buLlL8m1xa.fttk0Vac24dFEDE5Ul/s0PvDA+nq5S6UGG/6mncqJxE=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Enz8S4qXsudAdQbe3Sod.6zkjQFWmC+uV1x5DkPufhq.AAhB2kdf0Y252sWFnG9RTHCIYt7SZ+9sSM5uJ3eBhno=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EnQYUIjkLTKRWIW702n0.8V1Jta/418TBYgV16PxNGa.hzGAiMHv7SflPvwJSPPpa7jGBNA/zfyldCWn2cf6Lio=")
kk.loginResult()

ks = LINETCR.LINE()
ks.login(token="EnpV9kfXh5O8hRpcnSq2.5ZI9X23UFfjz9Yxw/jFEyG.zuWG/Uzp6tzdlukFNJoC1booeFk5wkhZMpxO0xYe5Mw=")
ks.loginResult()

kc = LINETCR.LINE()
kc.login(token="En4a6fFTnxgFSsHbTrQ7.MRMd87JLMY8NA0SCe7JEXW.g5WJ9Gj72yOylk6v7CE57r3/xACGiLhv/3NHQ+rdtC0=")		
kc.loginResult()

ka = LINETCR.LINE()
ka.login(token="EnpV9kfXh5O8hRpcnSq2.5ZI9X23UFfjz9Yxw/jFEyG.zuWG/Uzp6tzdlukFNJoC1booeFk5wkhZMpxO0xYe5Mw=")
ka.loginResult()
...
║•─✯͜͡ ᴀʀᴛʜᴜʀ★BOT
╠══════════════════
║line.me/ti/p/~getk3333
╚══════════════════
"""
helpMessage2 ="""✍Ŧ€₳M ж Ħ₳ʗҜ฿❂Ŧ✈
╔═══════════════════════
║❂➣[PROTECT: ON/OFF]:
║❂➣[BLOCK URL: ON/OFF]:
║❂➣[NAMELOCK: ON/OFF]:
